...
function App() {
  ...
  //getting allauthordata functions
  let getauthor = async () => {
    try {
  ...
  //api call only triggered at once
  useEffect(() => {
    ...
    <BrowserRouter>
      ...
      <div className="container-fluid">
        ...
        <Routes>
          <Route
            path="/"
            element={<Allbooks content={data.booklist} />}
          ></Route>
          <Route
            path="/allauthors"
            element={<Allauthors content={data.authorslist} />}
          ></Route>
